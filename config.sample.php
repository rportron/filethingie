...
function ft_settings_external_load() {
  ...
  $ft["settings"]["MAXSIZE"]           = 50000000; // Maximum file upload size - in bytes.
  ...
  $ft["settings"]["FILETYPEBLACKLIST"] = "php phtml php3 php4 php5 sql"; // File types that are not allowed for upload.
